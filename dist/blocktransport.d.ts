...
export interface BlockTransport {
     ...
     */
    startConsuming(localBlockCount: number, handler: (block: Block, blockCount: number, producerId: string) => Promise<void>): Promise<void>;
    /**
...
//# sourceMappingURL=blocktransport.d.ts.map